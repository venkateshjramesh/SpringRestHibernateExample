 ...
 */
@Entity
@Table(name="ball_bet_run")
public class BallBetRun {
    ...
    public BallBetRun(Integer id, Player player, Match match, Date modifiedDate, Date createdDate, Integer runs, Float over, Float ball, Long amount, MatchBetApplicable matchBetApplicable, String status) {
        this.id = id;
        this.player = player;
        this.match = match;
